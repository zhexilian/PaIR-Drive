...
import copy
from pairdrive.models.diffusiondrive.config import DiffusionDriveConfig as TransfuserConfig
from pairdrive.models.diffusiondrive.backbone import TransfuserBackbone
from navsim.common.enums import StateSE2Index
from diffusers.schedulers import DDIMScheduler
import torch.nn.functional as F
from pairdrive.models.diffusiondrive.blocks import linear_relu_ln,bias_init_with_prob, gen_sineembed_for_position, GridSampleCrossBEVAttention
...
class TrajectoryHead(nn.Module):
    ...
    def denorm_odo(self, odo_info_fut):
        ...
        return torch.cat([odo_info_fut_x, odo_info_fut_y, odo_info_fut_head], dim=-1)
    def forward(self, ego_query,agents_query,bev_feature,bev_spatial_shape,status_encoding,global_img=None) -> Dict[str, torch.Tensor]:
        """Run the two-step DiffusionDrive inference sampler."""
        step_num = 2
        ...
        return {"trajectory": poses_reg, "best_trajectory": best_reg}
